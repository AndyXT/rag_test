...
class QueryExecutor:
    ...
    async def execute_qa_chain(
        self, qa_chain, question: str, reranker=None
    ) -> Dict[str, Any]:
        """
    ...
    async def execute_manual_retrieval(
        ...
        prompt = self.query_processor.create_rag_prompt(
    ...
    def handle_file_descriptor_error(self, question: str) -> Dict[str, Any]:
        ...
        """
        RichLogger.warning(
            "Falling back to simple query without retrieval due to file descriptor error"
        )
