...
class DatabaseService:
    ...
    def initialize_vectorstore(
        ...
        chunk_size = chunk_size or self.settings_manager.get(
            "chunk_size", DEFAULT_CHUNK_SIZE
        )
        chunk_overlap = chunk_overlap or self.settings_manager.get(
        ...
        RichLogger.info(
            f"Vectorstore initialized with chunk_size={chunk_size}, overlap={chunk_overlap}"
        )
    ...
    def create_database(
        ...
        try:
            ...
            if progress_callback:
                progress_callback(
                    f"Starting database creation with {pdf_count} PDF files..."
                )
